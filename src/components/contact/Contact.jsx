...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_ci3sj89', 'template_zbrppiq', formRef.current, {
        publicKey: '9oUbT-5mlaBPx1MsW',
      })
      .then(
        () => {
          console.log('SUCCESS!');
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div variants={variants} className="item">
          <h2>Mail</h2>
          <span>darmanyamanh10@gmail.com</span>
        </motion.div>
        <motion.div variants={variants} className="item">
          <h2>Adress</h2>
          <span>Pemuda street Pekanbaru</span>
        </motion.div>
        <motion.div variants={variants} className="item">
          <h2>Phone</h2>
          <span>+62 812 6791 3593</span>
        </motion.div>
      </motion.div>
